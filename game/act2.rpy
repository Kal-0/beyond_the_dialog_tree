...
label monks_dont_attend_mass_mentioned:
    ...
    call count_clues from _call_count_clues
    return
...
label illegible_writing_mentioned:
    ...
    call count_clues from _call_count_clues_1
    return
...
label monks_wandering_mentioned:
    ...
    call count_clues from _call_count_clues_2
    return
...
label messy_rooms_mentioned:
    ...
    call count_clues from _call_count_clues_3
    return
...
label messy_library_mentioned:
    ...
    call count_clues from _call_count_clues_4
    return
...
label missing_poison_ingredients_mentioned:
    ...
    call count_clues from _call_count_clues_5
    return
...
label monks_not_eating_mentioned:
    ...
    call count_clues from _call_count_clues_6
    return
